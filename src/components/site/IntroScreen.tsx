...
export function IntroScreen() {
    ...
    useEffect(() => { // Hide the intro screen after allowing the fancy animation to play out
        ...
        <AnimatePresence> {
            show && (
                <motion.div key="intro-screen"
                    ...
                    <div className="relative z-10 flex font-display text-[20vh] font-extrabold tracking-[0.2em] text-transparent md:text-[35vh] lg:text-[40vh]">
                        {
                        text.map((char, i) => (
                            <motion.span key={i}
                                initial={
